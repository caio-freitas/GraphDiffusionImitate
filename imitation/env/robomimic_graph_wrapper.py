...
class RobomimicGraphWrapper(gym.Env):
    def __init__(self,
        ...
        self.NUM_GRAPH_NODES = 1 + self.num_objects if self.control_mode == "OSC_POSE" else 9 + self.num_objects
    ...
    def _robosuite_obs_to_robomimic_graph(self, obs):
        ...
        * requires robot_joint to be "flagged" in robomimic environment
        ...
        node_pos = self._get_node_pos(robot_i_data) # should have shape [2, 9]
